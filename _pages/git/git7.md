...
![HEAD示例](/assets/images/gitimg/7)  
改为指向```add distributed```：  
![HEAD示例](/assets/images/gitimg/8)  
...
批注: 还记得之前说过的```.git```这个目录不，所有git的相关信息都保存在这个目录下，例如各个commit的id，HEAD指向的版本ID等。除了以上的命令来找id，也可以来这个目录找